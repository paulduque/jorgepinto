...
<head>
    ...
    <meta property="og:title" content="@yield('og_title', $settings?->person_name ?? 'Jorge Pinto')">
    <meta property="og:description" content="@yield('og_description', $settings?->site_description ?? 'Sitio oficial de Jorge Pinto')">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:site_name" content="{{ $settings?->person_name ?? 'Jorge Pinto' }}">
    ...
    <meta name="twitter:title" content="@yield('og_title', $settings?->person_name ?? 'Jorge Pinto')">
    <meta name="twitter:description" content="@yield('og_description', $settings?->site_description ?? 'Sitio oficial de Jorge Pinto')">
